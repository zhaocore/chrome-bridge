...
#
# Usage:
#   curl -fsSL https://github.com/zhaocore/chrome-bridge-api/raw/refs/heads/master/bin/install.sh | bash
#   curl -fsSL https://github.com/zhaocore/chrome-bridge-api/raw/refs/heads/master/bin/install.sh | bash -s -- -h
#   curl -fsSL https://github.com/zhaocore/chrome-bridge-api/raw/refs/heads/master/bin/install.sh | bash -s -- --no-start
#   curl -fsSL https://github.com/zhaocore/chrome-bridge-api/raw/refs/heads/master/bin/install.sh | bash -s -- --no-skill
#
# What it does:
